...
public class labsfortest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_labsfortest);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(!states.get(position).equals("Select State")) {
                    ...
                    Toast.makeText(labsfortest.this, stateselected, Toast.LENGTH_LONG).show();
                    getstate();
                }
            }
